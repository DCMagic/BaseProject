...
@interface DCHorizontalScrollText ()
...
@implementation DCHorizontalScrollText
{
    CGFloat _selfWidth;
    CGFloat _selfHeight;
}
...
- (void)setInitialSettings {
    ...
    _moveMode = DCTextScrollWandering;
    _moveDirection = DCTextScrollMoveLeft;
...
- (void)setMoveMode:(DCTextScrollMode)moveMode {
    _moveMode = moveMode;
...
//    }
    ...
    switch (self.moveMode) {
        case DCTextScrollContinuous:
        {
            if (self.moveDirection == DCTextScrollMoveLeft) {
