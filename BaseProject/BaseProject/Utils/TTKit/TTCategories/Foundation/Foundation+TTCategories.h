...
#ifndef Foundation_TTCategories_h
#define Foundation_TTCategories_h
...
#import "NSString+Dir.h"                    // NSString 拼接文档路径
...
#import "NSArray+Log.h"                     // NSArray 数组字典 打印
...
#endif /* Foundation_TTCategories_h */
